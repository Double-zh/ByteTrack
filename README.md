...
python3 ZZH_track.py video -f exps/example/custom/yolox_voc_s_ZZH.py -c YOLOX_outputs/yolox_voc_s/latest_ckpt.pth.tar --fp16 --fuse --save_result
python3 ZZH_track.py webcam -f exps/example/custom/yolox_voc_s_ZZH.py -c YOLOX_outputs/yolox_voc_s/latest_ckpt.pth.tar --fp16 --fuse --save_result
python3 demo_track.py webcam -f exps/example/mot/yolox_x_ablation.py -c pretrained/bytetrack_ablation.pth.tar --fp16 --fuse --save_result
# ByteTrack
